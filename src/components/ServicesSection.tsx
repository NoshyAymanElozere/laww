...
export default function ServicesSection({ isAr }: ServicesSectionProps) {
  ...
  return (
    <section
      id="services"
      className="relative py-24 sm:py-36 bg-white overflow-hidden border-t border-gray-100 bg-[#0d4f53]"
    >
      ...
      <div className="bg-[#0d4f53] p-5">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
          ...
          <div className="max-w-3xl mb-20 text-right lg:text-inherit">
            ...
            <p className="text-white text-sm sm:text-base mt-4 font-light leading-relaxed">
